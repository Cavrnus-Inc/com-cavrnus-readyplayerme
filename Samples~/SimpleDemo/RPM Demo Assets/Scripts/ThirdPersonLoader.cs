...
namespace ReadyPlayerMe.Samples.QuickStart
{
    ...
    public class ThirdPersonLoader : MonoBehaviour
    {
        ...
        private ReadyPlayerMeManager rpmManager;
        ...
        private void Start()
        {
            rpmManager = GetComponent<ReadyPlayerMeManager>();
            rpmManager.ObjectLoader.OnCompleted += OnLoadCompleted;
            rpmManager.ObjectLoader.OnFailed += OnLoadFailed;
